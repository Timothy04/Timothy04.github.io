...
var G__11890 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__11890,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__11890;
}
}));
...
var len__4736__auto___11895 = arguments.length;
var i__4737__auto___11896 = (0);
while(true){
if((i__4737__auto___11896 < len__4736__auto___11895)){
args__4742__auto__.push((arguments[i__4737__auto___11896]));

var G__11897 = (i__4737__auto___11896 + (1));
i__4737__auto___11896 = G__11897;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq11892){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11893,G__11894,seq11892__$2);
}));
...
var file = cljs.core.get.call(null,map__11899__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__11899__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__11899__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__11898_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__11898_SHARP_));
...
var temp__5720__auto___11901 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11901)){
var message_11902 = temp__5720__auto___11901;
cljs.core.println.call(null,message_11902);
} else {
}
...
var temp__5720__auto___11903 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11903)){
var message_11904 = temp__5720__auto___11903;
cljs.core.println.call(null,message_11904);
} else {
}
...
var output_dir__$1 = (function (){var G__11905 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__11905,"/"].join('');
} else {
return G__11905;
}
})();
...
var temp__5718__auto__ = ((typeof exception.stack === 'string')?(function (){var G__11907 = exception.stack;
var G__11907__$1 = (((G__11907 == null))?null:clojure.string.split_lines.call(null,G__11907));
var G__11907__$2 = (((G__11907__$1 == null))?null:cljs.core.get.call(null,G__11907__$1,depth));
if((G__11907__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__11907__$2);
}
})():false);
if(cljs.core.truth_(temp__5718__auto__)){
var stack_element = temp__5718__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__11908 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__11908,(0),null);
var column = cljs.core.nth.call(null,vec__11908,(1),null);
var vec__11911 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__11911,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__11911,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__11911,(2),null);
...
var m__$1 = (function (){var G__11914 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__11918 = (function (){var G__11917 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__11917);
} else {
return G__11917;
}
})();
...
return cljs.core.vary_meta.call(null,G__11919,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__11923 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__11923,(0),null);
var types = vec__11923;
...
return cljs.core.map.call(null,(function (p__11926){
var vec__11927 = p__11926;
var ns = cljs.core.nth.call(null,vec__11927,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__11927,(1),null);
return (function (){
...
var G__11930 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__11930__$1 = (((G__11930 instanceof cljs.core.Keyword))?G__11930.fqn:null);
switch (G__11930__$1) {
case "async":
...
var seq__11931 = cljs.core.seq.call(null,vars__$1);
var chunk__11932 = null;
var count__11933 = (0);
var i__11934 = (0);
while(true){
if((i__11934 < count__11933)){
var v = cljs.core._nth.call(null,chunk__11932,i__11934);
var temp__5720__auto___11936 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11936)){
var t_11937 = temp__5720__auto___11936;
each_fixture_fn.call(null,((function (seq__11931,chunk__11932,count__11933,i__11934,t_11937,temp__5720__auto___11936,v,each_fixture_fn,G__11930,G__11930__$1,env,once_fixtures,each_fixtures,vec__11927,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11937)));
});})(seq__11931,chunk__11932,count__11933,i__11934,t_11937,temp__5720__auto___11936,v,each_fixture_fn,G__11930,G__11930__$1,env,once_fixtures,each_fixtures,vec__11927,ns,vars__$1))
);
} else {
}


var G__11938 = seq__11931;
var G__11939 = chunk__11932;
var G__11940 = count__11933;
var G__11941 = (i__11934 + (1));
seq__11931 = G__11938;
chunk__11932 = G__11939;
count__11933 = G__11940;
i__11934 = G__11941;
continue;
} else {
...
var c__4556__auto__ = cljs.core.chunk_first.call(null,seq__11931__$1);
var G__11942 = cljs.core.chunk_rest.call(null,seq__11931__$1);
var G__11943 = c__4556__auto__;
var G__11944 = cljs.core.count.call(null,c__4556__auto__);
var G__11945 = (0);
seq__11931 = G__11942;
chunk__11932 = G__11943;
count__11933 = G__11944;
i__11934 = G__11945;
continue;
} else {
var v = cljs.core.first.call(null,seq__11931__$1);
var temp__5720__auto___11946__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11946__$1)){
var t_11947 = temp__5720__auto___11946__$1;
each_fixture_fn.call(null,((function (seq__11931,chunk__11932,count__11933,i__11934,t_11947,temp__5720__auto___11946__$1,v,seq__11931__$1,temp__5720__auto__,each_fixture_fn,G__11930,G__11930__$1,env,once_fixtures,each_fixtures,vec__11927,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11947)));
});})(seq__11931,chunk__11932,count__11933,i__11934,t_11947,temp__5720__auto___11946__$1,v,seq__11931__$1,temp__5720__auto__,each_fixture_fn,G__11930,G__11930__$1,env,once_fixtures,each_fixtures,vec__11927,ns,vars__$1))
);
} else {
}


var G__11948 = cljs.core.next.call(null,seq__11931__$1);
var G__11949 = null;
var G__11950 = (0);
var G__11951 = (0);
seq__11931 = G__11948;
chunk__11932 = G__11949;
count__11933 = G__11950;
i__11934 = G__11951;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11930__$1)].join('')));
