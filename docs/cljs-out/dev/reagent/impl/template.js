...
var G__10928 = o;
goog.object.set(G__10928,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__10929__delegate = function (args){
...
while (G__10930__i < G__10930__a.length) {G__10930__a[G__10930__i] = arguments[G__10930__i + 0]; ++G__10930__i;}
  args = new cljs.core.IndexedSeq(G__10930__a,0,null);
} 
return G__10929__delegate.call(this,args);};
...
return G__10929__delegate(args);
});
...
var G__10932 = o;
goog.object.set(G__10932,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__10934__i < G__10934__a.length) {G__10934__a[G__10934__i] = arguments[G__10934__i + 0]; ++G__10934__i;}
  args = new cljs.core.IndexedSeq(G__10934__a,0,null);
} 
...
return G__10933__delegate(args);
});
...
var G__10936 = props;
var G__10936__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10936,cljs.core.cst$kw$id,id):G__10936);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10936__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__10936__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__10937 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10937,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__10937;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__10938){
var map__10939 = p__10938;
var map__10939__$1 = (((((!((map__10939 == null))))?(((((map__10939.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10939.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__10939):map__10939);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10939__$1,cljs.core.cst$kw$on_DASH_write);
...
return (jsprops.onChange = (function (p1__10941_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__10941_SHARP_);
}));
} else {
return null;
}
...
var vec__10944 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10944,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10944,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10944,(2),null);
...
var temp__5724__auto___10948 = reagent.impl.template.key_from_vec(v);
...
var temp__5724__auto___10950 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___10950 == null)){
} else {
var key_10951 = temp__5724__auto___10950;
(jsprops.key = key_10951);
}
...
var G__10952 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__10952) : reagent.impl.template.as_element.call(null,G__10952));
} else {
var temp__5724__auto___10953 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5724__auto___10953 == null)){
} else {
var key_10954 = temp__5724__auto___10953;
(jsprops.key = key_10954);
}
...
var G__10956 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__10956)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__10956)){
return x;
} else {
...
var len__4736__auto___10959 = arguments.length;
var i__4737__auto___10960 = (0);
while(true){
if((i__4737__auto___10960 < len__4736__auto___10959)){
args__4742__auto__.push((arguments[i__4737__auto___10960]));

var G__10961 = (i__4737__auto___10960 + (1));
i__4737__auto___10960 = G__10961;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq10957){
var G__10958 = cljs.core.first(seq10957);
var seq10957__$1 = cljs.core.next(seq10957);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10958,seq10957__$1);
}));
...
break;
default:
var G__10964 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__10964;
continue;
...
var ctx = ({});
var vec__10966 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10966,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10966,(1),null);
...
var G__10969 = (cljs.core.count(argv) - first_child);
switch (G__10969) {
case (0):
...
break;
case (1):
var G__10970 = component;
var G__10971 = jsprops;
var G__10972 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__10970,G__10971,G__10972);
