...
var G__16957 = devtools.prefs.pref.call(null,v);
v = G__16957;
continue;
} else {
return v;
...
}catch (e16960){var _e__16207__auto__ = e16960;
return false;
}})();
...
}catch (e16964){var _e__16207__auto__ = e16964;
return false;
}})();
...
}catch (e16966){var _e__16207__auto__ = e16966;
return false;
}}
}
});
...
var vec__16968 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__16968,(0),null);
var name = cljs.core.nth.call(null,vec__16968,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__16971_SHARP_);
}),template);
});
