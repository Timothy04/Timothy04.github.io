...
var o16383 = temp__5718__auto__;
var temp__5718__auto____$1 = (o16383["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o16384 = temp__5718__auto____$1;
return (o16384["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__16200__auto__ = f;
return (o__16200__auto__["toString"]).call(o__16200__auto__);
} else {
return "";
}
}catch (e16385){var _ = e16385;
return "";
}});
...
try{var o__16200__auto___16387 = t;
(o__16200__auto___16387["cljs$lang$ctorPrWriter"]).call(o__16200__auto___16387,t,writer);
}catch (e16386){var __16388 = e16386;
}
...
var char_code = (function (){var o__16200__auto__ = (new String(char$));
return (o__16200__auto__["charCodeAt"]).call(o__16200__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__16200__auto__ = String;
return (o__16200__auto__["fromCharCode"]).call(o__16200__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__16389 = num_code;
switch (G__16389) {
case (1):
return (185);
...
var o__16200__auto__ = String;
return (o__16200__auto__["fromCharCode"]).call(o__16200__auto__,superscript_code);
});
/**
...
}catch (e16391){var _e__16207__auto__ = e16391;
return false;
}})())){
...
var vec__16392 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__16392,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o16395 = temp__5718__auto__;
var temp__5718__auto____$1 = (o16395["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o16396 = temp__5718__auto____$1;
return (o16396["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__16399){
var vec__16400 = p__16399;
var ns_detector = cljs.core.nth.call(null,vec__16400,(0),null);
...
var G__16406 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__16407 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__16406;
remaining_tokens = G__16407;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq16397){
var G__16398 = cljs.core.first.call(null,seq16397);
var seq16397__$1 = cljs.core.next.call(null,seq16397);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16398,seq16397__$1);
}));
...
var vec__16411 = cljs.core.split_with.call(null,(function (p1__16410_SHARP_){
return cljs.core.not_EQ_.call(null,p1__16410_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__16411,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__16411,(1),null);
...
var vec__16417 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__16417,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__16417,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__16420 = cljs.core.rest.call(null,remaining_tokens);
var G__16421 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__16420;
name_tokens = G__16421;
continue;
} else {
...
var vec__16424 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__16424,(0),null);
var arity = cljs.core.nth.call(null,vec__16424,(1),null);
var vec__16427 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__16427,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__16427,(1),null);
var vec__16430 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__16430,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__16430,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__16430,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__16430,(3),null);
...
var vec__16436 = result;
var munged_ns = cljs.core.nth.call(null,vec__16436,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__16436,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__16436,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__16436,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__16436,(4),null);
var arity = cljs.core.nth.call(null,vec__16436,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__16440 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__16440,(0),null);
var args = cljs.core.nth.call(null,vec__16440,(1),null);
var vec__16443 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__16443,(0),null);
var name = cljs.core.nth.call(null,vec__16443,(1),null);
...
var G__16446 = (arity + (1));
var G__16447 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__16448){
var vec__16449 = p__16448;
var arity = cljs.core.nth.call(null,vec__16449,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__16449,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__16452_SHARP_){
return cljs.core.get.call(null,arities,p1__16452_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__16453_SHARP_){
return cljs.core.drop.call(null,(2),p1__16453_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__16456){
var vec__16457 = p__16456;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__16457,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq16454){
var G__16455 = cljs.core.first.call(null,seq16454);
var seq16454__$1 = cljs.core.next.call(null,seq16454);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16455,seq16454__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__16465__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__16465__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__16465__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__16465__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__16466 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__16466,(0),null);
var fn_name = cljs.core.nth.call(null,vec__16466,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__16466,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__16466,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__16466,(4),null);
var arity = cljs.core.nth.call(null,vec__16466,(5),null);
...
var o__16200__auto__ = f;
return (o__16200__auto__["getBasis"]).call(o__16200__auto__);
});
/**
...
}catch (e16470){var _e__16207__auto__ = e16470;
...
var G__16471 = (obj[cljs.core.first.call(null,path)]);
var G__16472 = cljs.core.rest.call(null,path);
obj = G__16471;
path = G__16472;
continue;
} else {
...
var _STAR_ = (function (accum,p__16473){
var vec__16474 = p__16473;
var bit = cljs.core.nth.call(null,vec__16474,(0),null);
var protocol = cljs.core.nth.call(null,vec__16474,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__16477){
var vec__16478 = p__16477;
var ns = cljs.core.nth.call(null,vec__16478,(0),null);
var name = cljs.core.nth.call(null,vec__16478,(1),null);
var selector = cljs.core.nth.call(null,vec__16478,(2),null);
...
var post_process = (function (p__16482){
var vec__16483 = p__16482;
var munged_name = cljs.core.nth.call(null,vec__16483,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__16483,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__16481_SHARP_){
return (obj[cljs.core.first.call(null,p1__16481_SHARP_)]);
}),sorted_matches);
