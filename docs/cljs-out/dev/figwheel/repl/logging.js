...
var c_15803 = (new goog.debug.Console());
var G__15802_15804 = c_15803.getFormatter();
goog.object.set(G__15802_15804,"showAbsoluteTime",false);

goog.object.set(G__15802_15804,"showRelativeTime",false);


goog.object.set(goog.debug.Console,"instance",c_15803);
...
figwheel.repl.logging.log_levels = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,clojure.string.lower_case,(function (p1__15805_SHARP_){
return goog.object.get(figwheel.repl.logging.LogLevel,p1__15805_SHARP_);
